...
const herbs = [
  ...
  // 🌿 D–G SERIES
  {
    ...
    description: "Local citrus fruit with sweet-sour taste, rich in Vitamin C.",
    purpose: "Used for cough, cold, sore throat, and weakness.",
    preparation: "Drink juice with honey; gargle warm water with dalandan juice and salt; eat fresh fruit for energy.",
    whenToApply: "For coughs, colds, or fatigue.",
    cautions: "Avoid in people with ulcers or GERD."
  },
  {
    name: "Damong Maria – Mugwort",
    description: "Aromatic shrub used for digestive and menstrual pain relief.",
    purpose: "For stomach ache, menstrual pain, and skin wounds.",
    preparation: "Boil 5–7 leaves in 2 cups of water; drink half cup. Apply crushed leaves on wounds.",
    whenToApply: "For stomach pain or menstrual cramps.",
    cautions: "Avoid during pregnancy."
  },
  {
    name: "Duhat – Java Plum",
    description: "Purple fruit with sweet-astringent taste; bark and leaves used medicinally.",
    purpose: "Used for diabetes, diarrhea, and mouth ulcers.",
    preparation: "Boil bark or leaves; drink ½ cup twice daily. Gargle decoction for mouth ulcers.",
    whenToApply: "For diabetes or diarrhea.",
    cautions: "May lower blood sugar significantly."
  },
  {
    name: "Dahon ng Saging – Banana Leaf",
    description: "Large tropical leaf used for burns and natural wound cover.",
    purpose: "Used for burns and wounds.",
    preparation: "Wash leaf and apply directly to affected area.",
    whenToApply: "For burns or wounds.",
    cautions: "External use only; ensure clean leaf."
  },
  {
    name: "Euphorbia – Tawa-tawa",
    description: "Grass-like weed traditionally used for dengue recovery and asthma.",
    purpose: "Used for dengue recovery, asthma, and skin wounds.",
    preparation: "Boil whole plant in 4 cups of water until half remains; drink ½ cup 3–4x daily.",
    whenToApply: "For dengue or asthma.",
    cautions: "Avoid overdose; may cause nausea."
  },
  {
    name: "Eucalyptus",
    description: "Aromatic tree with camphor scent used for respiratory relief.",
    purpose: "Used for cough, colds, and asthma.",
    preparation: "Inhale steam with eucalyptus oil; apply diluted oil on chest.",
    whenToApply: "For cough or asthma.",
    cautions: "Oil is toxic when ingested; avoid use on children."
  },
  {
    name: "Eggplant – Talong",
    description: "Common vegetable rich in fiber, good for cholesterol and digestion.",
    purpose: "Used for high cholesterol, burns, and constipation.",
    preparation: "Eat roasted or boiled; apply roasted skin to burns.",
    whenToApply: "For burns or digestion.",
    cautions: "May cause allergy in some individuals."
  },
  {
    name: "Elemi – Canarium luzonicum",
    description: "Native tree producing aromatic resin used for cough and wounds.",
    purpose: "Used for cough, bronchitis, wounds, and skin infections.",
    preparation: "Inhale steam with resin; apply resin on wounds.",
    whenToApply: "For cough or wounds.",
    cautions: "Avoid ingestion; may irritate skin."
  },
  {
    name: "Fennel – Anis",
    description: "Aromatic herb with feathery leaves used for digestion and lactation.",
    purpose: "Relieves bloating, cough, and increases milk flow.",
    preparation: "Crush 1 tsp seeds, steep in hot water for 10 mins; drink warm.",
    whenToApply: "After meals or during cough.",
    cautions: "Avoid during pregnancy unless advised by a doctor."
  },
  {
    name: "Gabi – Taro",
    description: "Root crop with edible leaves and tubers, high in fiber and minerals.",
    purpose: "Used for boils, swelling, and nutrition.",
    preparation: "Heat gabi leaves and apply to swelling; boil tubers for food.",
    whenToApply: "For swelling or nourishment.",
    cautions: "Cook thoroughly; raw gabi causes irritation."
  },
  {
    name: "Galing-galing – Red Ginger",
    description: "A spicy root used for sore throat, nausea, and inflammation.",
    purpose: "For sore throat, nausea, and cough.",
    preparation: "Boil slices in water for tea; chew raw slice for nausea.",
    whenToApply: "For sore throat or nausea.",
    cautions: "Avoid excess; may cause heartburn."
  },
  {
    name: "Gatas-gatas – Asthma Weed",
    description: "Small herb with white sap used for asthma and wound healing.",
    purpose: "For asthma, cough, and rashes.",
    preparation: "Boil fresh plant; drink ½ cup twice daily. Crush leaves and apply on skin.",
    whenToApply: "For asthma or rashes.",
    cautions: "Avoid during pregnancy."
  },
  {
    name: "Ginger – Luya",
    description: "Common spice with strong medicinal effects for cough and pain.",
    purpose: "Relieves nausea, cough, and joint pain.",
    preparation: "Boil slices for tea or apply warm compress on joints.",
    whenToApply: "For cough or pain.",
    cautions: "Avoid excess if with gallstones."
  },
  {
    name: "Gonggong – Sea Snail Herb",
    description: "Seafood used traditionally in coastal areas as folk skin treatment.",
    purpose: "Used for skin ailments and nutrition.",
    preparation: "Crush meat with salt and apply; or boil and eat.",
    whenToApply: "For minor skin issues.",
    cautions: "Avoid if allergic to shellfish."
  },
  {
    name: "Gumamela – Hibiscus",
    description: "Ornamental flower used for cough, fever, and skin rashes.",
    purpose: "Used for cough, colds, wounds, and skin care.",
    preparation: "Boil flowers; drink decoction or use as wound wash.",
    whenToApply: "For cough or wounds.",
    cautions: "Avoid pesticide-exposed flowers."
  }
];
